...
P99_WEAK(mbrtoc16)
size_t
mbrtoc16(char16_t *restrict _pc16, const char *restrict _s, size_t _n, mbstate_t *restrict _ps)
{
        static union p00_mbstate p00_state = {
            .p00_bytes = {0},
        };
        if (!_ps)
                _ps = &p00_state.p00_state;
        if (!_s) {
                _pc16 = 0;
                _s    = "";
                _n    = 1;
...
P99_WEAK(c16rtomb)
size_t
c16rtomb(char *restrict _s, char16_t _c16, mbstate_t *restrict _ps)
{
        static union p00_mbstate p00_state = {
            .p00_bytes = {0},
        };
...
P99_WEAK(mbrtoc32)
size_t
mbrtoc32(char32_t *restrict _pc32, const char *restrict _s, size_t _n, mbstate_t *restrict _ps)
{
        static union p00_mbstate p00_state = {
            .p00_bytes = {0},
        };
...
P99_WEAK(c32rtomb)
size_t
c32rtomb(char *restrict _s, char32_t _c32, mbstate_t *restrict _ps)
{

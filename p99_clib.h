 ...
 **/
p99_inline void *
aligned_alloc(size_t p00_alignment, size_t p00_size)
{
        void *p00_ret = 0;
 ...
 **/
p99_inline int
at_quick_exit(void (*p00_void_func)(void))
{
 ...
 **/
p99_inline int
at_thrd_exit(void (*p00_void_func)(void))
{
...
p99_inline int
p00_timespec_get(struct timespec *p00_ts, int p00_base)
{
        struct timeval t;
 ...
 ** @ingroup C11_library
 **/
p99_inline int timespec_get(struct timespec *p00_ts, int p00_base);
...
P99_CONST_FUNCTION
p99_inline clockid_t
           p00_getclockid(int base)
{
 ...
 **/
p99_inline int
timespec_get(struct timespec *p00_ts, int p00_base)
{

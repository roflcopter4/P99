...
void ignore_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err);
...
void abort_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err);


typedef void (*constraint_handler_t)(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err);

/**
 ** @brief sets the runtime-constraint handler to be handler.
 **/
p99_inline constraint_handler_t set_constraint_handler_s(constraint_handler_t handler);
...
strerror_s(char *p00_s, rsize_t p00_maxsize, errno_t p00_errnum)
{
        ...
        default: fprintf(stderr, "strerror_r returned %d\n", p00_ret); break;
        }
...
p00_constraint_report(errno_t p00_cond, const bool caught, char const *p00_file, char const *p00_context, char const *p00_info)
{
        ...
        if (!p00_context)
                p00_context = P00_JMP_BUF_CONTEXT;
        if (!p00_context)
                p00_context = "<unknown function>";
        if (!p00_info)
                p00_info = P00_JMP_BUF_INFO;
        if (!p00_file)
...
/* P99_CONST_FUNCTION */
p99_inline void
p99_ignore_handler(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err)
{
        P99_UNUSED(p00_msg);
        P99_UNUSED(p00_ptr);
        P99_UNUSED(p00_err);
...
void report_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err);
...
P99_WEAK(report_handler_s)
void
report_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err)
{
...
P99_WEAK(exit_handler_s)
noreturn void
exit_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err)
{
...
P99_WEAK(p99_constraint_handler)
void
p99_constraint_handler(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err)
{
        constraint_handler_t p00_func = atomic_load_explicit(&p00_constraint_handler, memory_order_acquire);
        if (p00_func)
                p00_func(p00_msg, p00_ptr, p00_err);
}
...
/* P99_CONST_FUNCTION */
void
ignore_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err)
{
...
P99_WEAK(abort_handler_s)
noreturn void
abort_handler_s(const char *restrict p00_msg, void *restrict p00_ptr, errno_t p00_err)
{
...
p00_constraint_call(errno_t p00_cond, char const *p00_file, char const *p00_context, char const *p00_info)
{
        if (p00_cond) {
                ...
                /* Ensure that all dependent data for this error has been */ /* synchronized. */
...
p00_memcpy_s(_Bool p00_overlap, void *restrict p00_s1, rsize_t p00_s1max, const void *restrict p00_s2, rsize_t p00_n)
{
        ...
        if (p00_n > RSIZE_MAX || p00_n > p00_s1max) {
                p00_ret = EDOM;
                goto P00_ERR;
        }
        if (!p00_overlap) {
...
p99_inline void *
p00_bsearch_s(char const *p00_file,
              ...
              void *p00_ctx)
{
        if (p00_nmemb) {
                if (p00_nmemb > RSIZE_MAX || p00_size > RSIZE_MAX) {
                        ...
                        for (register size_t p00_bot = -1, p00_top = p00_nmemb; (p00_top - p00_bot) != 1;) {
             ...
             const char *restrict p00_name)
{
        ...
        if (p00_maxsize > RSIZE_MAX) {
                ...
                if (p00_found) {
                        ...
                        if (p00_le < p00_maxsize)
                                strcpy(p00_value, p00_found);
                } else {
                        if (p00_maxsize)
                                p00_value[0] = '\0';
                }
...
p00_tmpfile_s(char const *p00_file, char const *p00_context, FILE *restrict *restrict p00_streamptr)
{
        ...
        if (p00_ret)
                p00_constraint_call(p00_ret, p00_file, p00_context, "tmpfile_s runtime constraint violation");
        return p00_ret;
}
...
p00_tmpnam_s(char const *p00_file, char const *p00_context, char *p00_s, rsize_t p00_maxsize)
{
        ...
        if (p00_ret)
                p00_constraint_call(p00_ret, p00_file, p00_context, "tmpnam_s runtime constraint violation");
        return p00_ret;
}
...
P99_PURE_FUNCTION
p99_inline bool
p00_isin0(char p00_c, rsize_t p00_s2l, uint8_t const p00_s2[const restrict p00_s2l])
{
        if (p00_c)
...
p99_inline char *
p00_strtok_s(char const *p00_file,
             char const *p00_context,
...
#   define P00_SPAN_DECLARE(NAME, SET)                                                                             \
        ...
        p99_inline char *P99_PASTE2(p99_strtok_, NAME)(                                                         \
            rsize_t * restrict p00_s1max, char p00_s1[restrict(*p00_s1max)], char **restrict p00_ptr)           \
        {                                                                                                       \
...
p99_inline bool
p00_tm_valid(struct tm const *p00_tm)
{
        /* int to unsigned conversion is always well defined and arithmetic
           ...
           bound. */
        return ((61u > (unsigned)p00_tm->tm_sec) // seconds after the minute — [0, 60]
           ...
           p00_asctime_s(char const *p00_file, char const *p00_context, char *p00_s, rsize_t p00_maxsize, const struct tm *p00_tptr)
{
        ...
        if (P99_UNLIKELY(p00_maxsize < 26 || p00_maxsize > RSIZE_MAX)) {
                ...
                char const p00_wday[7][3] = {"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"};
                char const p00_mon[12][3] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                             "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
                sprintf(p00_s, "%.3s %.3s %2d %.2d:%.2d:%.2d %4d\n", p00_wday[p00_tptr->tm_wday],
                        p00_mon[p00_tptr->tm_mon], p00_tptr->tm_mday, p00_tptr->tm_hour,
                        p00_tptr->tm_min, p00_tptr->tm_sec, 1900 + p00_tptr->tm_year);
        }
        if (p00_ret) {
                if (p00_s && p00_maxsize)
                        p00_s[0] = 0;
